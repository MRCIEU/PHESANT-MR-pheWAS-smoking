...
testContinuous(opt$resDir, opt$partIdx, opt$numParts, confounders, exposure, opt$traitofinterest, opt$userId, opt$phenoDir)

testCategoricalOrdered(opt$resDir, opt$partIdx, opt$numParts, confounders, exposure, opt$traitofinterest, opt$userId, opt$phenoDir)

testCategoricalUnordered(opt$resDir, opt$partIdx, opt$numParts, confounders, exposure, opt$traitofinterest, opt$userId, opt$phenoDir)
