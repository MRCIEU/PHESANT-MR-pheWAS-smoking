...
snpDir="${PROJECT_DATA}/smokingscore-snps/"


cat ${snpDir}snp-smokingscore-out*.gen > ${snpDir}smoking-score-snps.gen

####
# convert from gen to snp dosages
cat ${snpDir}smoking-score-snps.gen | python ../../../1-prepare-data/process-snps/gen_to_expected.py > ${snpDir}snps-all-expected.txt
