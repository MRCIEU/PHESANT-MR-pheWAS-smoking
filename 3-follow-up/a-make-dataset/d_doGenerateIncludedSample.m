...
snpdir=strcat(datadir,'/smokingscore-snps/');
qcdir = strcat(datadir,'/qc/');

snpScore=dataset('file',strcat(snpdir,'smokescore-withPhenIds.csv'),'delimiter',',');
...
export(snpScore, 'file',strcat(snpdir,'smokescore-withPhenIds-subset.csv'),'delimiter',',');
