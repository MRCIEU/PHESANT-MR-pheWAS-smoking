...
log using "`resDir'/results-21753/facialaging-followup/csi-causal-estimate-with-boots-sensitivityx`ixStart'.log", text replace
...
program define myboots, rclass
	 preserve 
	  bsample
	  ivprobit facial_agingBin sex age pc* (csi = smokescore)
...
file open myfile using "`resDir'/results-21753/facialaging-followup/csi-causal-estimate-boots-sensitivityx`ixStart'.txt", write replace
